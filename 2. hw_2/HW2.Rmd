...
- Most of the people who eat caviar are also wealthy, and wealth gives better access to high-quality healthcare or less involvement in life-threatening jobs


b.	What sort of variation would identify the answer to the research question? 

- One would need lifespan data about almost-equal subjects where their only difference is eating caviar or not   
...
- One can do an experiment where the treatment of eating caviar is randomly assigned. Then researchers could see if the treatment is associated to a longer lifespan.
...
Because that third variable would show that the association between the treatment and the outcome was spurious. It is not there, after you account for it. If the research design does not block that path (through randomization or statistical controls), then there could be an alternate explanation to the relation between those variables.
