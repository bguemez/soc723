...
_In DID we don't have to assume that because we have a similar group to compare, where we can observe the effect of time also on the control group_



### 2.	Which of the following potential back doors is controlled for by comparing the treated group to a control group?

_c.	There may be differences in typical outcome levels between the treated group and the untreated group_
...
_It would be equal to the average of the effects from the three periods, so (5+1+.6)/3 = 2.2
