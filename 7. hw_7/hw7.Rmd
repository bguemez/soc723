...
***Retail businesses with 11-20 employees** There is simply no way to compare an untreated group similar to this because there is no information.*
...
***Yes** We can't do the counterfactual because we couldn't estimate Y(treated).*

#### c. What concern might we have about there only being one untreated Service business with 11-20 employees?

*That observation will be the **only** match for the 5 service businesses on the treated group, increasing sampling variance a lot*
...
Our analysis will be restricted to only those groups that were able to find a match.
